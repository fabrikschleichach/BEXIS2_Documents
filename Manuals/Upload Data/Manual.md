...
If your data covers all or a whole range of BETA-FOR patches, you can either provide some general information here (e.g. GeoLocationPlace = Germany) or skip this field and only ![refer to the geographic information dataset](https://github.com/fabrikschleichach/BEXIS2_Documents/blob/master/Manuals/Upload%20Data/Manual.md#39-related-identifiers).
